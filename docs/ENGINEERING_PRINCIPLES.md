...
See [ARCHITECTURE.md](./ARCHITECTURE.md#workflow-modes) for implementation details.

---

## Clinical Anatomy Engine (CAE)

The Clinical Anatomy Engine is the foundation of PainLocator.
...
See [JSON_SCHEMA.md](./JSON_SCHEMA.md) for session export structure.
...
See [ROADMAP.md](./ROADMAP.md) and [PRODUCT_VISION.md](./PRODUCT_VISION.md).
