...
| `likeness` | object | Optional appearance prefs: `skin` (`natural` \| `fair` \| `light` \| `olive` \| `tan` \| `brown` \| `deep`), `weight` (`slim` \| `average` \| `heavy`), `height` (`short` \| `average` \| `tall`). Presentation only. |
